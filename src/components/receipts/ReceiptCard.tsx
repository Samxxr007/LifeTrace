          ...
          <div className="flex items-center space-x-2">
            {onClick ? (
              <button
                ...
                className="font-body font-medium text-ink-900 truncate text-sm md:text-base text-left hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-ink-900 rounded-xs"
